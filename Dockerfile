...
RUN curl https://ltb-project.org/archives/self-service-password_1.1-1_all.deb > self-service-password.deb
RUN dpkg -i self-service-password.deb
RUN rm -f self-service-password.deb
